...
def extract_mfcc(full_audio_path):
    ...
    mfcc_features = mfcc(wave, winstep=int(sample_rate * 0.03), samplerate=sample_rate, ceplifter=12)[0]
...
def main():
    trainDir = 'D:/process_voice_classify/sample_code/hmm_speech_recognition_demo-master/train_audio/'
    ...
    testDir = 'D:/process_voice_classify/sample_code/hmm_speech_recognition_demo-master/test_audio/'
